...
1. Configure non-sensitive environment variables in `srcs/.env`:
   ```env
   ...
   ```
2. Populate credentials in the `secrets/` directory (these must remain untracked in Git):
...
- [NGINX Documentation & FastCGI Configuration](https://nginx.org/en/docs/)
- [MariaDB Server Official Knowledge Base](https://mariadb.com/kb/en/)
